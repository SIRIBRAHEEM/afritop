...
export const metadata: Metadata = {
  title: "Documentation",
  description:
    "Afritop docs — how to buy airtime, data and prepaid electricity with USDC on Arc: supported countries, payments, wallets, fees, delivery, security and troubleshooting.",
};
...
const STEPS = [
  ...
  },
  {
    ...
    text: "Your wallet opens automatically — approve the exact USDC amount on Arc. No account, no card.",
  },
  {
    n: 4,
    color: "#8b5cf6",
...
const WALLETS = [
  { name: "MetaMask", url: "https://metamask.io/download/", note: "The most popular EVM wallet — browser extension + mobile." },
  { name: "Coinbase Wallet", url: "https://www.coinbase.com/wallet", note: "Self-custody wallet from Coinbase — web + mobile." },
      ...
      <div className="relative mx-auto max-w-6xl px-4 py-12 sm:px-6 sm:py-16">
        ...
        <div className="max-w-3xl">
          ...
          <p className="mt-4 text-lg leading-relaxed text-ink-500">
            Everything you need to know about topping up Africa with USDC — how it works,
            which countries and services we cover, how payments settle on-chain, and how to
        ...
        <div className="mt-12 lg:grid lg:grid-cols-[230px_1fr] lg:gap-10">
          ...
          <div className="space-y-8">
            ...
            {/* Countries & services */}
            <Section id="countries" title="Countries & services" lead="Airtime, data and prepaid electricity for four countries — everything priced in local currency and paid in USDC.">
              <div className="mt-6 grid gap-4 sm:grid-cols-2">
                {COUNTRIES.map((c) => (
              ...
              <div className="mt-5 grid gap-3 sm:grid-cols-3">
                {[
                  ...
                  { id: "data" as const, label: "Data bundles", text: "Pre-priced bundles with clear validity — 500MB to full gigabyte packs." },
            ...
            {/* Wallets */}
            <Section id="wallets" title="Wallets" lead="Any EVM wallet works. We detect what's installed automatically (EIP-6963) — no setup, no accounts.">
            ...
            {/* Pricing */}
            <Section id="pricing" title="Pricing & fees" lead="Face value plus a flat platform fee — shown before you pay. No hidden margins, ever.">
              <div className="mt-6 grid gap-4 sm:grid-cols-3">
                {[
                  { label: "Face value", text: "You pay the exact price of the top-up in local currency, converted to USDC." },
                  { label: "Platform fee", text: "A flat 1.5% of the USD amount (minimum $0.05) — the whole bill, up front." },
              ...
              <p className="mt-5 text-xs leading-relaxed text-ink-500">
                Exchange rates come from a live source and update every minute — the rate you see at checkout is the rate you get.
              </p>
            </Section>
            ...
            <Section id="delivery" title="Delivery & receipts" lead="Airtime lands in seconds; electricity tokens are generated the moment payment settles.">
              <ul className="mt-6 list-disc space-y-2 pl-5 text-sm leading-relaxed text-ink-600">
                <li><strong className="text-ink-900">Airtime & data</strong> — credited to the number within seconds of on-chain confirmation.</li>
                <li><strong className="text-ink-900">Electricity</strong> — a 20-digit recharge token appears on your receipt; enter it on your meter.</li>
                <li><strong className="text-ink-900">Receipts</strong> — every order saves a receipt with the token, amount and on-chain transaction link.</li>
                ...
                <li><strong className="text-ink-900">No account needed</strong> — receipts also stay saved on your device, even before you sign in.</li>
              </ul>
            </Section>
            ...
            <Section id="security" title="Security" lead="Self-custody by design — your money stays in your wallet until you approve.">
              <ul className="mt-6 list-disc space-y-2 pl-5 text-sm leading-relaxed text-ink-600">
                <li><strong className="text-ink-900">Self-custody</strong> — we never see or store your private keys. USDC leaves your wallet only when you approve.</li>
                <li><strong className="text-ink-900">No card, no KYC</strong> — nothing to leak. Your payment details are your wallet signature.</li>
                <li><strong className="text-ink-900">On-chain proof</strong> — every payment is verifiable on ArcScan; every receipt links to its transaction.</li>
            ...
            <Section id="troubleshooting" title="Troubleshooting" lead="Quick fixes for the things that occasionally trip people up.">
              <div className="mt-6 space-y-4">
                {[
                  ...
                  { q: "My wallet says 'add network'", a: "Approve adding Arc Testnet once — that's the network we settle on. It's a one-time step." },
                  ...
                  { q: "Wrong number entered", a: "Always double-check the number before approving payment — top-ups are delivered to the number you entered and are final once sent." },
                ].map((f) => (
            ...
            {/* Support */}
            <Section id="support" title="Support" lead="Real humans, fast replies — tap a channel below.">
