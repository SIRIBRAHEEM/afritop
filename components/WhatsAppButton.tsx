...
/**
 * Floating WhatsApp support button — replaces the in-app chat. Opens a
 * WhatsApp chat with the Afritop support number in a new tab.
 */
  ...
  return (
    <div className="fixed bottom-5 right-5 z-[60] sm:bottom-6 sm:right-6">
      <a
        ...
        className="group relative grid size-14 place-items-center rounded-full border-2 border-ink-950 bg-[#25d366] text-white shadow-[0_10px_30px_-8px_rgba(10,10,10,0.6)] transition-all duration-300 hover:-translate-y-1 hover:scale-105 hover:bg-[#1ebe5d] hover:shadow-[0_16px_40px_-8px_rgba(10,10,10,0.7)]"
      >
        {/* Soft availability ping */}
